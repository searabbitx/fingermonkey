...
class Args:
    def __init__(self):
        parser = argparse.ArgumentParser(
            prog="./fingermonkey.py", description="A tool that detects versions of open source apps based on the world-readable assets such as images, js, css or static html.")
